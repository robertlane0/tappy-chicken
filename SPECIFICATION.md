# Flappy Bird: High-Level Game Specification

This specification describes the core mechanics and behavior of the original Flappy Bird at a gameplay and systems level, independent of any particular implementation language or engine.

---

# 1. Game Overview

Flappy Bird is a real-time, single-player, endless arcade game centered around maintaining controlled flight through a procedurally generated sequence of obstacles.
...
Instead of the bird moving forward through the world:

* The bird stays approximately fixed horizontally.
...
The bird is the only controllable entity.
...
The bird cycles through wing frames.
...
* Bird cannot leave the visible top.
* Bird may clip slightly before descending.
...
The bird's horizontal position crosses completely beyond the pipe pair without collision.
